...
class I18NWriterTest {
    ...
    @Test
    void testGetLicenseTextApache2() throws IOException {
        testGetLicenseTextPredefined("Apache-2.0");
    }

    @Test
    void testGetLicenseTextBSD2Clause() throws IOException {
        testGetLicenseTextPredefined("BSD-2-Clause");
    }

    @Test
    void testGetLicenseTextEPL10() throws IOException {
        testGetLicenseTextPredefined("EPL-1.0");
    }

    @Test
    void testGetLicenseTextGPL20() throws IOException {
        testGetLicenseTextPredefined("GPL-2.0");
    }

    @Test
    void testGetLicenseTextGPL30() throws IOException {
        testGetLicenseTextPredefined("GPL-3.0");
    }

    @Test
    void testGetLicenseTextLGPL20() throws IOException {
        testGetLicenseTextPredefined("LGPL-2.0");
    }

    @Test
    void testGetLicenseTextLGPL21() throws IOException {
        testGetLicenseTextPredefined("LGPL-2.1");
    }

    @Test
    void testGetLicenseTextMIT() throws IOException {
        testGetLicenseTextPredefined("MIT");
    }

    @Test
    void testGetLicenseTextMPL20() throws IOException {
    ...
    @Test
    void testGetLicenseCopyrightHolder() {
    ...
    @Test
    void testGetLicenseCopyrightYear() {
